...
class MedicineGenerator {
    companion object{
        fun generateData():ArrayList<Medicine> {
            ...
            tempList.add(Medicine(R.drawable.gabapentin, "Gabapentin", 300, "mg", "Three times a day", listOf(0,1,2), 3, "January 3, 2025", "December 29, 2026"))
            tempList.add(Medicine(R.drawable.maltofer, "Maltofer", 15, "ml", "Once a day", listOf(2), 4, "January 4, 2025", "December 28, 2026"))
